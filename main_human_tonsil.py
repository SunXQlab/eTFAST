...
# 全局路径
dir_name ='./results_human_tonsil_0820'
DATA_DIR = "./data/"
...
# 创建目录
for dir_path in [DATA_DIR, MODEL_DIR,PROCESS_DIR, TG_PRED_DIR, LOSS_DIR]:
...
if __name__ == "__main__":
    adata_path = os.path.join(DATA_DIR, "3_human_tonsil_slide_tags/human_tonsil_processed.h5ad")
    main(adata_path)